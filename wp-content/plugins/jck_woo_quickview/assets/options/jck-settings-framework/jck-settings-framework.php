...
if (!class_exists('JckSettingsFramework')) {
    ...
    class JckSettingsFramework {
        ...
        public function adminEnqueueScripts()
    	{
            ...
            wp_register_script( $this->option_group.'-timepicker', $this->options_url.'js/timepicker/jquery.ui.timepicker.js', array('jquery', 'jquery-ui-core'), false, true );
            wp_enqueue_script( $this->option_group.'-timepicker' );
            
            wp_register_script( $this->option_group.'-scripts', $this->options_url.'js/scripts.js', array('jquery'), false, true );
            wp_enqueue_script( $this->option_group.'-scripts' );
            
            wp_register_style( $this->option_group.'-styles', $this->options_url.'css/styles.css' );
			wp_enqueue_style( $this->option_group.'-styles' );
    	}
