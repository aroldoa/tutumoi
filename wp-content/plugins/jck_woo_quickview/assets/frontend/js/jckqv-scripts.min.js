...
function jckqv_setupPopup(){magnificPopup=jQuery.magnificPopup,jQuery("body").on(jckqv.settings.trigger_general_method,"*[data-jckqvpid]",function(){jQuery.magnificPopup=magnificPopup;var e=jckqv_getProducts(),i=jQuery(this).attr("data-jckqvpid"),a=jckqv_getArrayIndexForKey(e,"src",jckqv.ajaxurl+"?pid="+i);return jQuery.magnificPopup.open({items:e,type:"ajax",ajax:{settings:{type:"POST",data:{action:"jckqv",nonce:jckqv.nonce}}},gallery:{enabled:1==jckqv.settings.popup_general_gallery?!0:!1},closeOnContentClick:!1,callbacks:{ajaxContentAdded:function(){$sliderEl=jQuery("#jckqv #jckqv_images"),$sliderElClone=$sliderEl.clone(),$variations_form=jQuery("#jckqv form.variations_form"),$img_container=jQuery("#jckqv_images"),$loadedClass="jckLoaded",jckqv_setupSlider(),jckqv_setupVariationWatcher(),jckqv_setupResetImgs()}}},a),jQuery("body").trigger("jckqv_open"),!1})}function jckqv_getProducts(){var e=[],i=[];return jQuery("*[data-jckqvpid]").each(function(){var a=jQuery(this).attr("data-jckqvpid");-1===jQuery.inArray(a,i)&&(i.push(a),e.push({src:jckqv.ajaxurl+"?pid="+a}))}),jQuery("body").trigger("jckqv_getProducts"),e}function jckqv_setupAddToCart(){jQuery("body").on("submit","#jckqv form.cart",function(e){e.preventDefault();var i=jQuery(this),a=jQuery(this).serialize(),t=jQuery("#addingToCart"),n=t.find("span"),r=t.find("i"),o="jckqv-icon-cw animate-spin",s="jckqv-icon-ok";r.addClass(o).removeClass(s),n.text("Adding to Cart..."),t.fadeIn(),jQuery(".onsale").fadeOut(),jckqv_addToCart(a,function(){return r.addClass(s).removeClass(o),n.text("Added!"),t.delay(1e3).fadeOut(),jQuery(".onsale").delay(1e3).fadeIn(),i.find(":disabled").prop("disabled",!1),!1})})}function jckqv_addToCart(e,i){jQuery.get("/?post_type=product&"+e,function(){"function"==typeof i&&i()})}function jckqv_setupSlider(){$controlNav=$sliderElClone.children().length>1?jckqv.settings.popup_imagery_thumbnails:"none",$sliderArgs={autoScaleSlider:!0,autoScaleSliderWidth:jckqv.imgsizes.single.width,autoScaleSliderHeight:jckqv.imgsizes.single.height,keyboardNavEnabled:!0,imageScaleMode:jckqv.settings.popup_imagery_imgscale,imageScalePadding:0,arrowsNavAutoHide:!1,slidesSpacing:0,controlNavigation:$controlNav,slidesOrientation:jckqv.settings.popup_imagery_imgtransition,transitionType:"fade"==jckqv.settings.popup_imagery_imgtransition?"fade":"move",transitionSpeed:jckqv.settings.popup_imagery_transitionspeed,arrowsNav:1==jckqv.settings.popup_imagery_navarr?!0:!1,arrowsNavAutoHide:1==jckqv.settings.popup_imagery_hidenavarr?!0:!1,thumbs:{fitInViewport:!1,transitionSpeed:jckqv.settings.popup_imagery_transitionspeed,autoCenter:!1,spacing:0,orientation:"horizontal",arrows:!0,arrowsAutoHide:!0}},$sliderEl.royalSlider($sliderArgs)}function jckqv_setupVariationWatcher(){$alreadyLoaded=$variations_form.hasClass($loadedClass)?!1:!0,$variations_form.on("change",function(){""==jQuery("input[name=variation_id]").val()||$alreadyLoaded||($chosen_var=[{variation_id:jQuery("input[name=variation_id]").val()}],$variations_form.trigger("show_variation",$chosen_var),$variations_form.addClass($loadedClass))}),$variations_form.on("show_variation",function(e,i){$img_container.hasClass("loading")||($var_id=$swatches?jQuery("input[name=variation_id]").val():i.variation_id,jckqv_imgTrans($var_id),$variations_form.addClass($loadedClass))}),$swatches&&""!=jQuery("input[name=variation_id]").val()&&$variations_form.trigger("show_variation")}function jckqv_setupResetImgs(){$swatches?$variations_form.on("reset_image",jckqv_resetImg()):$variations_form.on("reset_image",function(){jckqv_resetImg()})}function jckqv_resetImg(){$img_container.hasClass("loading")||$img_container.hasClass("reset")||($var_id=0,jckqv_imgTrans($var_id))}function jckqv_imgTrans(e){var i=$sliderEl.data("royalSlider"),a=jQuery($sliderElClone).find('[data-jckqv~="-'+e+'-"]'),t=a.length>0?a.index():0;i.goTo(t)}function jckqv_setupHoverbtn(){jQuery("body").on({mouseenter:function(){var e=jQuery(this).find("*[data-jckqvpid]");e.length>0&&e.css({visibility:"visible"}).stop().animate({opacity:1},150)},mouseleave:function(){var e=jQuery(this).find("*[data-jckqvpid]");e.length>0&&e.stop().animate({opacity:0},150,function(){jQuery(this).css({visibility:"hidden"})})}},jckqv.settings.trigger_styling_hoverel)}function jckqv_getArrayIndexForKey(e,i,a){for(var t=0;t<e.length;t++)if(e[t][i]==a)return t;return-1}var magnificPopup,$sliderEl,$sliderElClone;$swatches="function"==typeof variation_calculator?!0:!1,jQuery(document).ready(function(){jckqv_setupPopup(),1==jckqv.settings.popup_content_ajaxcart&&jckqv_setupAddToCart(),1==jckqv.settings.trigger_styling_autohide&&jckqv_setupHoverbtn()});